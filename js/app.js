// products load function and data
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    //display products result code
    div.innerHTML = `<div class="card single-product radius-5 p-4 h-100">
      <div>
    <img class="product-image" src="${product.image}"></img>
      ...
      <div>
        ...
        <button id="details-btn" class="btn px-4">Details</button></div>
      </div>
      `;
